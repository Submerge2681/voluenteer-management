    ...
    <div className="mt-8">
      ...
      <div className="flex flex-wrap gap-2 justify-center sm:justify-between">
        ...
        <button
          ...
          className="p-3 flex items-center justify-center bg-linear-to-r from-[#E1306C] via-[#C13584] to-[#833AB4] text-white rounded-2xl transition-all active:scale-95 shadow-sm"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
